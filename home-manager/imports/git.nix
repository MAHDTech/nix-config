...

{
  ...
  programs.git = {
    ...
    aliases = {
      ...
      review = "!vim -p $(git files) +\"tabdo Gdiff $REVIEW_BRANCH\" +\"let g:gitgutter_diff_base = '$REVIEW_BRANCH'\"" ;

      # Lazy review with vim of a single file provided
      reviewone = "!vim -p +\"tabdo Gdiff $REVIEW_BRANCH\" +\"let g:gitgutter_diff_base = '$REVIEW_BRANCH'\"" ;
