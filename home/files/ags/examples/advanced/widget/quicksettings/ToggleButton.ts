...
export const ArrowToggleButton = ({ name, icon, label, activate, deactivate, activateOnArrow = true, connection: [service, condition] }: ArrowToggleButtonProps) =>
  Widget.Box({
...
export const SimpleToggleButton = ({ icon, label, toggle, connection: [service, condition] }: SimpleToggleButtonProps) =>
  Widget.Button({
    on_clicked: toggle,
