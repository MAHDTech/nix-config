...
declare module "gi://Wp?version=0.5" {
  ...
  export namespace Wp {
     ...
     */
    function base_dirs_new_files_iterator(flags: BaseDirsFlags | null, subdir?: string | null, suffix?: string | null): Iterator
     ...
     * @param user_data
     */
    function log_writer_default(log_level: GLib.LogLevelFlags | null, fields: GLib.LogField, n_fields: number, user_data?: any | null): GLib.LogWriterOutput
    /**
    ...
    class Client extends GlobalProxy implements PipewireObject {
       ...
       */
      enum_params(id?: string | null, filter?: SpaPod | null, cancellable?: Gio.Cancellable | null): Promise<Iterator | null>
      /**
       * Enumerate object parameters.
       *
       *
       ...
       * @param callback a callback to call with the result
       */
      enum_params(id?: string | null, filter?: SpaPod | null, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<this> | null): Promise<Iterator | null> | void
      /**
    ...
    class Core extends Object {
       ...
       */
      load_component(component: string | null, type: string, args?: SpaJson | null, provides?: string | null, cancellable?: Gio.Cancellable | null): Promise<boolean>
      /**
       * Loads the specified `component` on `self`.
       *
       *
       ...
       * @returns TRUE if the sync operation was started, FALSE if an error occurred before returning from this function
       */
      sync(cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<this> | null): Promise<boolean> | void
      /**
    ...
    class Link extends GlobalProxy implements PipewireObject {
      ...
      connect_after(signal: "state-changed", callback: (_source: this, object: LinkState, p0: LinkState) => void): number
    ...
    class Metadata extends GlobalProxy {
      ...
      connect_after(id: string, callback: (...args: any[]) => any): number
      emit(id: string, ...args: any[]): void
      connect(signal: "changed", callback: (_source: this, object: number, p0: string, p1: string, p2: string) => void): number
      connect_after(signal: "changed", callback: (_source: this, object: number, p0: string, p1: string, p2: string) => void): number
    ...
    class Node extends GlobalProxy implements PipewireObject {
      ...
      connect_after(signal: "state-changed", callback: (_source: this, object: NodeState, p0: NodeState) => void): number
    ...
    abstract class Object extends GObject.Object {
       ...
       * @param callback a function to call when activation is complete
       */
      activate(features: ObjectFeatures, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<this> | null): Promise<boolean> | void
      /**
    ...
    abstract class Proxy extends Object {
      ...
      connect_after(signal: "error", callback: (_source: this, object: number, p0: number, p1: string) => void): number
    ...
    class SpaDevice extends Proxy {
      ...
      connect_after(id: string, callback: (...args: any[]) => any): number
      emit(id: string, ...args: any[]): void
      connect(signal: "create-object", callback: (_source: this, object: number, p0: string, p1: string, p2: Properties) => void): number
      connect_after(signal: "create-object", callback: (_source: this, object: number, p0: string, p1: string, p2: Properties) => void): number
    ...
    class ObjectInterest {
       ...
       */
      add_constraint(type: ConstraintType | null, subject: string, verb: ConstraintVerb | null, value?: GLib.Variant | null): void
      /**
       ...
       */
      matches_full(flags: InterestMatchFlags | null, object_type: GObject.GType, object?: GObject.Object | null, pw_props?: Properties | null, pw_global_props?: Properties | null): InterestMatch
      /**
    ...
    interface SiAcquisition extends SessionItem {
       ...
       * @param callback the callback to call when the operation is done
       */
      acquire(acquisitor: SiLink, item: SiLinkable, callback?: Gio.AsyncReadyCallback<this> | null): Promise<boolean> | void
      /**
    ...
    interface SiAdapter extends SessionItem {
       ...
       * @param callback the callback to call when the operation is done
       */
      set_ports_format(format?: SpaPod | null, mode?: string | null, callback?: Gio.AsyncReadyCallback<this> | null): Promise<boolean> | void
      /**
