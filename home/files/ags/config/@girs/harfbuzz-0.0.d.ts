...
declare module "gi://HarfBuzz?version=0.0" {
  ...
  export namespace HarfBuzz {
     ...
     */
    function aat_layout_feature_type_get_name_id(face: face_t, feature_type: aat_layout_feature_type_t | null): ot_name_id_t
    /**
     ...
     */
    function buffer_deserialize_glyphs(buffer: buffer_t, buf: string[], font: font_t | null, format: buffer_serialize_format_t | null): [bool_t, string]
    /**
     ...
     * @returns `true` if parse was successful, `false` if an error occurred.
     */
    function buffer_deserialize_unicode(buffer: buffer_t, buf: string[], format: buffer_serialize_format_t | null): [bool_t, string]
    /**
     ...
     * @returns The number of serialized items.
     */
    function buffer_serialize_unicode(buffer: buffer_t, start: number, end: number, format: buffer_serialize_format_t | null, flags: buffer_serialize_flags_t | null): [number, Uint8Array, number]
    /**
     ...
     */
    function font_add_glyph_origin_for_direction(font: font_t, glyph: codepoint_t, direction: direction_t | null, x: position_t, y: position_t): [position_t, position_t]
    /**
     ...
     * @param direction The direction of the text segment
     */
    function font_get_glyph_advance_for_direction(font: font_t, glyph: codepoint_t, direction: direction_t | null): [position_t, position_t]
    /**
     ...
     */
    function font_get_glyph_advances_for_direction(font: font_t, direction: direction_t | null, count: number, first_glyph: codepoint_t, glyph_stride: number): [position_t, number]
    /**
     ...
     * @returns `true` if data found, `false` otherwise
     */
    function font_get_glyph_contour_point_for_origin(font: font_t, glyph: codepoint_t, point_index: number, direction: direction_t | null): [bool_t, position_t, position_t]
    /**
     ...
     * @returns `true` if data found, `false` otherwise
     */
    function font_get_glyph_extents_for_origin(font: font_t, glyph: codepoint_t, direction: direction_t | null): [bool_t, glyph_extents_t]
    /**
     ...
     * @param direction The direction of the text segment
     */
    function font_get_glyph_kerning_for_direction(font: font_t, first_glyph: codepoint_t, second_glyph: codepoint_t, direction: direction_t | null): [position_t, position_t]
    /**
     ...
     * @param direction The direction of the text segment
     */
    function font_get_glyph_origin_for_direction(font: font_t, glyph: codepoint_t, direction: direction_t | null): [position_t, position_t]
    /**
     ...
     */
    function font_subtract_glyph_origin_for_direction(font: font_t, glyph: codepoint_t, direction: direction_t | null, x: position_t, y: position_t): [position_t, position_t]
    /**
     ...
     */
    function ot_layout_get_baseline(font: font_t, baseline_tag: ot_layout_baseline_tag_t | null, direction: direction_t | null, script_tag: tag_t, language_tag: tag_t): [bool_t, position_t | null]
    /**
     * Fetches a baseline value from the face.
     *
     ...
     * @param language_tag language tag, currently unused.
     */
    function ot_layout_get_baseline_with_fallback(font: font_t, baseline_tag: ot_layout_baseline_tag_t | null, direction: direction_t | null, script_tag: tag_t, language_tag: tag_t): position_t
    /**
     * Fetches a baseline value from the face, and synthesizes
     * it if the font does not have it.
     *
     ...
     */
    function ot_layout_get_font_extents(font: font_t, direction: direction_t | null, script_tag: tag_t, language_tag: tag_t): [bool_t, font_extents_t | null]
    /**
     * Fetches script/language-specific font extents.  These values are
     * looked up in the `BASE` table's `MinMax` records.
     *
     ...
     * @returns `true` if found script/language-specific font extents.
     */
    function ot_layout_get_font_extents2(font: font_t, direction: direction_t | null, script: script_t | null, language?: language_t | null): [bool_t, font_extents_t | null]
    /**
     ...
     */
    function ot_layout_get_ligature_carets(font: font_t, direction: direction_t | null, glyph: codepoint_t, start_offset: number): [number, position_t[]]
    /**
     ...
     */
    function ot_layout_lookup_get_optical_bound(font: font_t, lookup_index: number, direction: direction_t | null, glyph: codepoint_t): position_t
    /**
     ...
     */
    function ot_math_get_glyph_assembly(font: font_t, glyph: codepoint_t, direction: direction_t | null, start_offset: number): [number, ot_math_glyph_part_t[], position_t]
    /**
     ...
     */
    function ot_math_get_glyph_kerning(font: font_t, glyph: codepoint_t, kern: ot_math_kern_t | null, correction_height: position_t): position_t
    /**
     ...
     */
    function ot_math_get_glyph_kernings(font: font_t, glyph: codepoint_t, kern: ot_math_kern_t | null, start_offset: number): [number, ot_math_kern_entry_t[]]
    /**
     ...
     */
    function ot_math_get_glyph_variants(font: font_t, glyph: codepoint_t, direction: direction_t | null, start_offset: number): [number, ot_math_glyph_variant_t[]]
    /**
     ...
     * @param metrics_tag tag of metrics value you like to fetch.
     */
    function ot_metrics_get_position_with_fallback(font: font_t, metrics_tag: ot_metrics_tag_t | null): position_t | null
    /**
     ...
     */
    function ot_tags_from_script_and_language(script: script_t | null, language?: language_t | null, script_count?: number, language_count?: number): [number, tag_t | null, number, tag_t | null]
    /**
