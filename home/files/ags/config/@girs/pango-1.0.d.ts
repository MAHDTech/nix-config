...
declare module "gi://Pango?version=1.0" {
  ...
  export namespace Pango {
     ...
     */
    function gravity_get_for_script(script: Script | null, base_gravity: Gravity | null, hint: GravityHint | null): Gravity
    /**
     ...
     */
    function gravity_get_for_script_and_width(script: Script | null, wide: boolean, base_gravity: Gravity | null, hint: GravityHint | null): Gravity
    /**
     ...
     */
    function itemize_with_base_dir(context: Context, base_dir: Direction | null, text: string, start_index: number, length: number, attrs: AttrList, cached_iter?: AttrIterator | null): Item[]
    /**
     ...
     */
    function shape_item(item: Item, paragraph_text: string | null, paragraph_length: number, log_attrs: LogAttr | null, glyphs: GlyphString, flags: ShapeFlags | null): void
    /**
     * Convert the characters in `text` into glyphs.
     *
     * Given a segment of text and the corresponding `PangoAnalysis` structure
     ...
     * @param flags flags influencing the shaping process
     */
    function shape_with_flags(item_text: string, item_length: number, paragraph_text: string | null, paragraph_length: number, analysis: Analysis, glyphs: GlyphString, flags: ShapeFlags | null): void
    /**
    ...
    abstract class Renderer extends GObject.Object {
       ...
       * @param x22 X coordinate of right end of bottom of trapezoid
       */
      draw_trapezoid(part: RenderPart | null, y1_: number, x11: number, x21: number, y2: number, x12: number, x22: number): void
      /**
