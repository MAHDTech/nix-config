...
declare module "gi://GObject?version=2.0" {
  ...
  export namespace GObject {
     ...
     */
    export type SignalCallback<Emitter, Fn> = Fn extends (...args: infer P) => infer R ? (source: Emitter, ...args: P) => R : never
     ...
     */
    function param_spec_boolean(name: string, nick: string | null, blurb: string | null, default_value: boolean, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_boxed(name: string, nick: string | null, blurb: string | null, boxed_type: GType, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_char(name: string, nick: string | null, blurb: string | null, minimum: number, maximum: number, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_double(name: string, nick: string | null, blurb: string | null, minimum: number, maximum: number, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_enum(name: string, nick: string | null, blurb: string | null, enum_type: GType, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_flags(name: string, nick: string | null, blurb: string | null, flags_type: GType, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_float(name: string, nick: string | null, blurb: string | null, minimum: number, maximum: number, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_gtype(name: string, nick: string | null, blurb: string | null, is_a_type: GType, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_int(name: string, nick: string | null, blurb: string | null, minimum: number, maximum: number, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_int64(name: string, nick: string | null, blurb: string | null, minimum: number, maximum: number, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_long(name: string, nick: string | null, blurb: string | null, minimum: number, maximum: number, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_object(name: string, nick: string | null, blurb: string | null, object_type: GType, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_param(name: string, nick: string | null, blurb: string | null, param_type: GType, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_pointer(name: string, nick: string | null, blurb: string | null, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_string(name: string, nick: string | null, blurb: string | null, default_value: string | null, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_uchar(name: string, nick: string | null, blurb: string | null, minimum: number, maximum: number, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_uint(name: string, nick: string | null, blurb: string | null, minimum: number, maximum: number, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_uint64(name: string, nick: string | null, blurb: string | null, minimum: number, maximum: number, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_ulong(name: string, nick: string | null, blurb: string | null, minimum: number, maximum: number, default_value: number, flags: ParamFlags | null): ParamSpec
    /**
     ...
     * @returns a newly created parameter specification
     */
    function param_spec_unichar(name: string, nick: string | null, blurb: string | null, default_value: string, flags: ParamFlags | null): ParamSpec
    /**
     ...
     */
    function param_spec_variant(name: string, nick: string | null, blurb: string | null, type: GLib.VariantType, default_value: GLib.Variant | null, flags: ParamFlags | null): ParamSpec
    /**
     ...
     */
    function type_register_dynamic(parent_type: GType, type_name: string, plugin: TypePlugin, flags: TypeFlags | null): GType
    /**
     ...
     */
    function type_register_fundamental(type_id: GType, type_name: string, info: TypeInfo, finfo: TypeFundamentalInfo, flags: TypeFlags | null): GType
    /**
     ...
     * @returns the new type identifier
     */
    function type_register_static(parent_type: GType, type_name: string, info: TypeInfo, flags: TypeFlags | null): GType
    /**
    ...
    interface ClosureMarshal {
      (closure: Closure, return_value: Value | null, param_values: (Value | any)[], invocation_hint?: any | null, marshal_data?: any | null): void
    }
    ...
    interface SignalAccumulator {
      (ihint: SignalInvocationHint, return_accu: Value | any, handler_return: Value | any, data?: any | null): boolean
    }
    ...
    class BindingGroup extends Object {
       ...
       */
      bind_full(source_property: string, target: Object, target_property: string, flags: BindingFlags | null, transform_to?: Closure | null, transform_from?: Closure | null): void
      /**
    ...
    class Object {
       ...
       */
      bind_property(source_property: string, target: Object, target_property: string, flags: BindingFlags | null): Binding
      /**
       ...
       * @returns the #GBinding instance representing the     binding between the two #GObject instances. The binding is released     whenever the #GBinding reference count reaches zero.
       */
      bind_property_full(source_property: string, target: Object, target_property: string, flags: BindingFlags | null, transform_to: Closure | null, transform_from: Closure | null): Binding
      /**
    ...
    abstract class ParamSpec<A = unknown> {
       ...
       * @param defaultValue The default value for this property
       */
      static string(name: string, nick: string | null, blurb: string | null, flags: ParamFlags | number, defaultValue: string): ParamSpec<string>
      /**
    ...
    class SignalGroup extends Object {
       ...
       */
      connect_data(detailed_signal: string, c_handler: Callback, notify: ClosureNotify, flags: ConnectFlags | null): void
      /**
       * Connects `c_handler` to the signal `detailed_signal`
       * on the target instance of `self`.
       *
