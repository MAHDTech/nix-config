...
declare module "gi://GdkPixbuf?version=2.0" {
  ...
  export namespace GdkPixbuf {
    ...
    class Pixbuf extends GObject.Object implements Gio.Icon, Gio.LoadableIcon {
       ...
       */
      composite_color_simple(dest_width: number, dest_height: number, interp_type: InterpType | null, overall_alpha: number, check_size: number, color1: number, color2: number): Pixbuf | null
      /**
