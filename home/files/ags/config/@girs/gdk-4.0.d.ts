...
declare module "gi://Gdk?version=4.0" {
  ...
  export namespace Gdk {
     ...
     */
    function content_deserialize_async(stream: Gio.InputStream, mime_type: string, type: GObject.GType, io_priority: number, cancellable?: Gio.Cancellable | null): Promise<[GObject.Value]>
    /**
     * Read content from the given input stream and deserialize it, asynchronously.
     *
     * The default I/O priority is %G_PRIORITY_DEFAULT (i.e. 0), and lower numbers
     ...
     * @param cancellable optional `GCancellable` object
     */
    function content_serialize_async(stream: Gio.OutputStream, mime_type: string, value: GObject.Value | any, io_priority: number, cancellable?: Gio.Cancellable | null): Promise<boolean>
    /**
     * Serialize content and write it to the given output stream, asynchronously.
     *
     * The default I/O priority is %G_PRIORITY_DEFAULT (i.e. 0), and lower numbers
    ...
    class Clipboard extends GObject.Object {
       ...
       * @param cancellable optional `GCancellable` object
       */
      read_async(mime_types: string[], io_priority: number, cancellable?: Gio.Cancellable | null): Promise<[Gio.InputStream | null, string]>
      /**
       * Asynchronously requests an input stream to read the `clipboard'`s
       * contents from.
       *
       ...
       * @param callback callback to call when the request is satisfied
       */
      read_async(mime_types: string[], io_priority: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<this> | null): Promise<[Gio.InputStream | null, string]> | void
      /**
       ...
       * @param callback callback to call when the request is satisfied
       */
      read_text_async(cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<this> | null): Promise<string | null> | void
      /**
       * Finishes an asynchronous clipboard read.
       *
       ...
       * @param callback callback to call when the request is satisfied
       */
      read_texture_async(cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<this> | null): Promise<Texture | null> | void
      /**
       * Finishes an asynchronous clipboard read.
       *
       ...
       * @param cancellable optional `GCancellable` object
       */
      read_value_async(type: GObject.GType, io_priority: number, cancellable?: Gio.Cancellable | null): Promise<GObject.Value>
      /**
       * Asynchronously request the `clipboard` contents converted to the given
       * `type`.
       *
       ...
       * @param callback callback to call when the request is satisfied
       */
      read_value_async(type: GObject.GType, io_priority: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<this> | null): Promise<GObject.Value> | void
      /**
       * Finishes an asynchronous clipboard read.
       *
       ...
       * @param callback callback to call when the request is satisfied
       */
      store_async(io_priority: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<this> | null): Promise<boolean> | void
      /**
    ...
    class Display extends GObject.Object {
       ...
       */
      translate_key(keycode: number, state: ModifierType | null, group: number): [boolean, number, number, number, ModifierType | null]
    }
    ...
    class DmabufTexture extends Texture implements Paintable, Gio.Icon, Gio.LoadableIcon {
       ...
       * @param callback a #GAsyncReadyCallback   to call when the request is satisfied
       */
      load_async(size: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback<this> | null): Promise<[Gio.InputStream, string]> | void
      /**
    ...
    class MemoryTexture extends Texture implements Paintable, Gio.Icon, Gio.LoadableIcon {
      ...
      static ["new"](width: number, height: number, format: MemoryFormat, bytes: GLib.Bytes | Uint8Array, stride: number): MemoryTexture
    ...
    interface Toplevel extends Surface {
       ...
       * @param timestamp timestamp of mouse click that began the drag (use   [method@Gdk.Event.get_time])
       */
      begin_resize(edge: SurfaceEdge | null, device: Device | null, button: number, x: number, y: number, timestamp: number): void
      /**
