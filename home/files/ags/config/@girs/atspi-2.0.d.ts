...
declare module "gi://Atspi?version=2.0" {
  ...
  export namespace Atspi {
     ...
     * @returns %TRUE if successful, otherwise %FALSE.
     */
    function generate_keyboard_event(keyval: number, keystring: string | null, synth_type: KeySynthType | null): boolean
    /**
     ...
     * @returns %TRUE if successful, otherwise %FALSE.
     */
    function register_keystroke_listener(listener: DeviceListener, key_set: KeyDefinition[] | null, modmask: KeyMaskType, event_types: KeyEventMask, sync_type: KeyListenerSyncType | null): boolean
    /**
    ...
    class Accessible extends Object implements Action, Collection, Component, Document, EditableText, Hypertext, Image, Selection, Table, TableCell, Text, Value {
       ...
       */
      get_matches(rule: MatchRule, sortby: CollectionSortOrder | null, count: number, traverse: boolean): Accessible[]
      /**
       ...
       */
      get_matches_from(current_object: Accessible, rule: MatchRule, sortby: CollectionSortOrder | null, tree: CollectionTreeTraversalType | null, count: number, traverse: boolean): Accessible[]
      /**
       ...
       */
      get_bounded_ranges(x: number, y: number, width: number, height: number, type: CoordType | null, clipTypeX: TextClipType | null, clipTypeY: TextClipType | null): TextRange[]
      /**
       ...
       * @returns #TRUE if successful, #FALSE otherwise.
       */
      scroll_substring_to_point(start_offset: number, end_offset: number, coords: CoordType | null, x: number, y: number): boolean
      /**
