...
export default function VerificationWindow(_gdkmonitor: Gdk.Monitor) {
  ...
  return (
    <PopupWindow name={WINDOW_NAME} exclusivity={Astal.Exclusivity.IGNORE} animation="popin 90%">
      <box cssClasses={["window-content", "verification-container"]} vertical spacing={6}>
        <label label={bind(powermenu, "title").as(String)} cssClasses={["title"]} />
