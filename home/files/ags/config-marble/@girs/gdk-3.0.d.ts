...
declare module "gi://Gdk?version=3.0" {
  ...
  export namespace Gdk {
     ...
     * @returns %GDK_GRAB_SUCCESS if the grab was successful.
     */
    function pointer_grab(window: Window, owner_events: boolean, event_mask: EventMask | null, confine_to: Window | null, cursor: Cursor | null, time_: number): GrabStatus
    /**
    ...
    function synthesize_window_state(window: Window, unset_flags: WindowState | null, set_flags: WindowState | null): void
    /**
     ...
     */
    function test_simulate_button(window: Window, x: number, y: number, button: number, modifiers: ModifierType | null, button_pressrelease: EventType | null): boolean
    /**
     * This function is intended to be used in GTK+ test programs.
     ...
     */
    function test_simulate_key(window: Window, x: number, y: number, keyval: number, modifiers: ModifierType | null, key_pressrelease: EventType | null): boolean
    /**
    ...
    abstract class Device extends GObject.Object {
       ...
       * @returns %GDK_GRAB_SUCCESS if the grab was successful.
       */
      grab(window: Window, grab_ownership: GrabOwnership | null, owner_events: boolean, event_mask: EventMask | null, cursor: Cursor | null, time_: number): GrabStatus
      /**
    ...
    class Keymap extends GObject.Object {
       ...
       */
      translate_keyboard_state(hardware_keycode: number, state: ModifierType | null, group: number): [boolean, number, number, number, ModifierType | null]
    }
    ...
    abstract class Seat extends GObject.Object {
       ...
       * @returns %GDK_GRAB_SUCCESS if the grab was successful.
       */
      grab(window: Window, capabilities: SeatCapabilities | null, owner_events: boolean, cursor?: Cursor | null, event?: Event | null, prepare_func?: SeatGrabPrepareFunc | null): GrabStatus
      /**
    ...
    abstract class Window extends GObject.Object {
       ...
       */
      begin_resize_drag(edge: WindowEdge | null, button: number, root_x: number, root_y: number, timestamp: number): void
      /**
       * Begins a window resize operation (for a toplevel window).
       ...
       * @param timestamp timestamp of mouse click that began the drag (use gdk_event_get_time())
       */
      begin_resize_drag_for_device(edge: WindowEdge | null, device: Device, button: number, root_x: number, root_y: number, timestamp: number): void
      /**
       ...
       */
      create_similar_image_surface(format: cairo.Format | null, width: number, height: number, scale: number): cairo.Surface
      /**
       ...
       */
      move_to_rect(rect: Rectangle, rect_anchor: Gravity | null, window_anchor: Gravity | null, anchor_hints: AnchorHints | null, rect_anchor_dx: number, rect_anchor_dy: number): void
      /**
