...
declare module "gi://AstalHyprland?version=0.1" {
  ...
  export namespace AstalHyprland {
    ...
    class Hyprland extends GObject.Object {
      ...
      connect_after(signal: "minimize", callback: (_source: this, client: Client, minimize: boolean) => void): number
      ...
      connect_after(signal: "floating", callback: (_source: this, client: Client, floating: boolean) => void): number
      ...
      connect_after(signal: "client-moved", callback: (_source: this, client: Client, ws: Workspace) => void): number
      ...
      connect(signal: "keyboard-layout", callback: (_source: this, keyboard: string, layout: string) => void): number
      connect_after(signal: "keyboard-layout", callback: (_source: this, keyboard: string, layout: string) => void): number
