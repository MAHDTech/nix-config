...
declare module "gi://AstalIO?version=0.1" {
  ...
  export namespace AstalIO {
     ...
     * @param _callback_
     */
    function read_sock(conn: Gio.SocketConnection, _callback_?: Gio.AsyncReadyCallback<Gio.SocketConnection> | null): Promise<string> | void
     ...
     * @param _callback_
     */
    function write_sock(conn: Gio.SocketConnection, response: string, _callback_?: Gio.AsyncReadyCallback<Gio.SocketConnection> | null): Promise<void> | void
     ...
     * @param _callback_
     */
    function read_file_async(path: string, _callback_?: Gio.AsyncReadyCallback<string> | null): Promise<string> | void
     ...
     * @param _callback_
     */
    function write_file_async(path: string, content: string, _callback_?: Gio.AsyncReadyCallback<string> | null): Promise<void> | void
