...
buildNpmPackage (finalAttrs: {
  ...
  installPhase = ''
    ...
    cp -r bundle $out/share/gemini-cli-custom
    ...
    cp -r node_modules $out/share/gemini-cli-custom/

    rm -f $out/share/gemini-cli-custom/docs/CONTRIBUTING.md
